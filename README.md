...
3. you should create your database in mongodb and pass the connection string with the name of MONGO_URI to the .env file which you need to create yourself in root folder of a project.
